    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->horizontalLayout->addWidget(playImage);
    QWidget *centerWidget = ui->centralwidget;
    
    // 获取该 widget 的布局对象，这里是 QVBoxLayout
    QVBoxLayout *layout = qobject_cast<QVBoxLayout*>(centerWidget->layout());  // 获取布局指针
    
    layout->addWidget(playImage);
...
void MainWindow::on_check_HW_clicked(bool checked)
{
